...
- **Detached panes**: move a tab into a window of its own from its context menu.
...
The tab context menu exposes core's `pane:detach-item` command for its target tab.
